...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self,type):
        ...
        if type == 'fly':
            ...
            snail_1 = pygame.image.load('graphics/snail/snail1.png').convert_alpha() # need to deal with alpha values
            snail_2 = pygame.image.load('graphics/snail/snail2.png').convert_alpha() # need to deal with alpha values
...
# Snail
snail_frame_1 = pygame.image.load('graphics/snail/snail1.png').convert_alpha() # need to deal with alpha values
snail_frame_2 = pygame.image.load('graphics/snail/snail2.png').convert_alpha() # need to deal with alpha values
